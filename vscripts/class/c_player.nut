...
var function CodeCallback_RegisterClass_C_Player()
{
	...
	function C_Player::IsDisabledFor( weaponType )
	{		
		return ( this.disabledWeaponTypes & expect int( weaponType ) ) != 0
	}
	
	function C_Player::ToggleDisabledWeaponType_internal( weaponType, toggle ) 
	{
		if( toggle )
	...
	function C_Player::GetWeaponDisabledFlags()
	{
